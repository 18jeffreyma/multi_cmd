...
import os, sys
from multi_cmd.rl_utils.single_state_multi_copg import SingleStateMultiCoPG, SingleStateMultiSimGD
...
train_wrap = SingleStateMultiCoPG(
    env,
    policies,
    tol=1e-5,
    batch_size=batch_size,
    device=device,
    potential=potentials.squared_distance(1./1e-5)
)
